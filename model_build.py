...
num_values = 200  # You can adjust this to your desired number of values

# Generate random integers
min_value = 0  # Minimum integer value
max_value = 100  # Maximum integer value
...
session3  = ort.InferenceSession("hvdet_fuse_stage3.onnx", providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])        
